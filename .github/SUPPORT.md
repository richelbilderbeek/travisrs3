# Getting help with travisrs3

Thanks for using travisrs3. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/travisrs3/issues) to make sure the 
